...
import $ from 'jquery'
import { handleResizeOnScrollablePane } from './scrollable_pane'
...
window.addEventListener('resize', handleResizeOnScrollablePane);
// Call it once on page load to apply the correct style
