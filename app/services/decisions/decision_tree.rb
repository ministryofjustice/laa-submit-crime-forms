module Decisions
  class DecisionTree < DslDecisionTree
    ...
    PRIOR_AUTHORITY_TASKLIST = 'prior_authority/steps/start_page'.freeze
    ...
    from(:ufn).goto(show: PRIOR_AUTHORITY_TASKLIST)

    # ---------------------------------
    # prior authority application steps
    # ---------------------------------
    from(:case_contact).goto(show: PRIOR_AUTHORITY_TASKLIST)
    from(:client_detail).goto(show: PRIOR_AUTHORITY_TASKLIST)
    from(:primary_quote).goto(show: PRIOR_AUTHORITY_TASKLIST)

    # prison law flow
    from(:next_hearing).goto(show: PRIOR_AUTHORITY_TASKLIST)
    ...
    from(:hearing_detail)
      ...
      .goto(show: PRIOR_AUTHORITY_TASKLIST)
    from(:youth_court).goto(show: PRIOR_AUTHORITY_TASKLIST)
    from(:psychiatric_liaison).goto(show: PRIOR_AUTHORITY_TASKLIST)

    from(:reason_why).goto(show: PRIOR_AUTHORITY_TASKLIST)
  end
end
