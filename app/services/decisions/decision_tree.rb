module Decisions
  class DecisionTree < DslDecisionTree
    ...
    from(:firm_details)
      ...
      .goto(edit: 'steps/defendant_details', defendant_id: ->(inst) { inst.id })
    ...
    from(:claim_details)
      ...
      .goto(edit: 'steps/work_item', work_item_id: ->(inst) { inst.id })
    ...
    from(:letters_calls)
      ...
      .goto(edit: 'steps/disbursement_type', disbursement_id: ->(inst) { inst.id })
