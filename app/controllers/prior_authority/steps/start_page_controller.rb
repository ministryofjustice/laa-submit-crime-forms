module PriorAuthority
  module Steps
    class StartPageController < BaseController
      def show
        # TODO: requires more routes and logic so leaving for now as not sure what
        # flow logic this represents
        ...
        render 'laa_multi_step_forms/task_list/show', locals: { header: -> { decision_step_header }, app_type: 'application' }
      end
    end
  end
end
