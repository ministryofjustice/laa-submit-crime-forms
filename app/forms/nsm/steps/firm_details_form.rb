module Nsm
  module Steps
    class FirmDetailsForm < ::Steps::BaseFormObject
      ...
      def firm_office
        @firm_office ||= Nsm::Steps::FirmDetails::FirmOfficeForm.new(firm_office_fields.merge(application:))
      end

      def solicitor
        @solicitor ||= Nsm::Steps::FirmDetails::SolicitorForm.new(solicitor_fields.merge(application:))
      end
      ...
      def solicitor_fields
        fields = Nsm::Steps::FirmDetails::SolicitorForm.attribute_names + ['alternative_contact_details']
