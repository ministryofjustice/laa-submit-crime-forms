...
unless ENV['NOCOVERAGE']
  SimpleCov.start do
    ...
    minimum_coverage branch: 60.00, line: 80
  end
end
...
VCR.configure do |vcr_config|
  ...
  vcr_config.filter_sensitive_data('<GOOGLE_SHEETS_PRIVATE_KEY>') { ENV.fetch('GOOGLE_SHEETS_PRIVATE_KEY', nil) }
  vcr_config.filter_sensitive_data('<GOOGLE_SHEETS_PRIVATE_KEY_ID>') { ENV.fetch('GOOGLE_SHEETS_PRIVATE_KEY_ID', nil) }
end
